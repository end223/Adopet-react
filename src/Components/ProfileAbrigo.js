...
import loggedUser from "../assets/logged-abrigo.png";
import { api } from "../api";

function AbrigoProfile() {
  ...
  const { user } = useContext(AuthContextAbrigos);
    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="user-pic">
          ...
          <img id='userPic' src={loggedUser} alt="Abrigo" />
